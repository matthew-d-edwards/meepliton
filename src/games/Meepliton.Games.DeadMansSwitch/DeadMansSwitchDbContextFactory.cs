...
/// Not used at runtime — the app constructs DeadMansSwitchDbContext via DI using IConfiguration.
///
...
/// are hardcoded here.
/// </summary>
public class DeadMansSwitchDbContextFactory : IDesignTimeDbContextFactory<DeadMansSwitchDbContext>
{
    public DeadMansSwitchDbContext CreateDbContext(string[] args)
    {
        ...
        var options = new DbContextOptionsBuilder<DeadMansSwitchDbContext>()
            .UseNpgsql(connectionString,
                npgsql => npgsql.MigrationsHistoryTable("__EFMigrationsHistory_deadmansswitch"))
            .Options;

        return new DeadMansSwitchDbContext(options);
    }
}
