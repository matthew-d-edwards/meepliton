...
/// Not used at runtime — the app constructs SushiGoDbContext via DI using IConfiguration.
///
...
/// are hardcoded here.
/// </summary>
public class SushiGoDbContextFactory : IDesignTimeDbContextFactory<SushiGoDbContext>
{
    public SushiGoDbContext CreateDbContext(string[] args)
    {
        ...
        var options = new DbContextOptionsBuilder<SushiGoDbContext>()
            .UseNpgsql(connectionString,
                npgsql => npgsql.MigrationsHistoryTable("__EFMigrationsHistory_sushigo"))
            .Options;

        return new SushiGoDbContext(options);
    }
}
