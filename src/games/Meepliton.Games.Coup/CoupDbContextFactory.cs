...
/// Not used at runtime — the app constructs CoupDbContext via DI using IConfiguration.
///
...
/// are hardcoded here.
/// </summary>
public class CoupDbContextFactory : IDesignTimeDbContextFactory<CoupDbContext>
{
    public CoupDbContext CreateDbContext(string[] args)
    {
        ...
        var options = new DbContextOptionsBuilder<CoupDbContext>()
            .UseNpgsql(connectionString,
                npgsql => npgsql.MigrationsHistoryTable("__EFMigrationsHistory_coup"))
            .Options;

        return new CoupDbContext(options);
    }
}
